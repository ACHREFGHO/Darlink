    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center p-4">
            <div className="mb-6 flex flex-col items-center w-full">
                ...
                <p className="text-secondary-foreground/80 font-medium tracking-wide animate-fade-in-up transition-all duration-300 hover:text-darlink-orange hover:scale-105 cursor-default">{t.resetPassword.secureAccount}</p>
            </div>
            <ResetPasswordForm />
        </div>
    )
